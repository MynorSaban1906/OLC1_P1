...
class String(Function):
    ...
    def interpreter(self, tree, table):
        ...
        simbolo = table.getTabla("string##param1") # crea una variable con el nombre complicado, algo que nunca vendra
        ...
        return str(simbolo.getValue()) # se devuelve el valor ya tuncado por la funcion math.trunc 
